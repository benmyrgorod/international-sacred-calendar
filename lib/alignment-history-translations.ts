...
> = {
  en: {
    ...
    methodNote: "Calendar proximity is a pattern for exploration, not evidence that the cycle caused an event. Some recalculated offsets differ from the supplied infographic.",
    ...
    imageAlt: "Illustrated historical panorama from the Great Pyramid through the Storming of the Bastille",
  },
  he: {
    ...
    methodNote: "קרבה בלוח היא דפוס לעיון, לא הוכחה שהמחזור גרם לאירוע. חלק מההפרשים שחושבו מחדש שונים מן האינפוגרפיקה שסופקה.",
    ...
    imageAlt: "פנורמה היסטורית מאוירת מן הפירמידה הגדולה ועד הסתערות הבסטיליה",
  },
  ar: {
    ...
    methodNote: "التقارب التقويمي نمط للاستكشاف وليس دليلاً على أن الدورة سببت الحدث. بعض الفوارق المعاد حسابها تختلف عن الرسم المرفق.",
    ...
    imageAlt: "بانوراما تاريخية مصورة من الهرم الأكبر إلى اقتحام الباستيل",
  },
  it: {
    ...
    methodNote: "La prossimità nel calendario è uno spunto da esplorare, non prova che il ciclo abbia causato un evento. Alcuni scarti ricalcolati differiscono dall’infografica fornita.",
    ...
    imageAlt: "Panorama storico illustrato dalla Grande Piramide alla presa della Bastiglia",
  },
  el: {
    ...
    methodNote: "Η ημερολογιακή εγγύτητα είναι μοτίβο προς διερεύνηση, όχι απόδειξη ότι ο κύκλος προκάλεσε ένα γεγονός. Ορισμένες νέες αποκλίσεις διαφέρουν από το δοσμένο γράφημα.",
    ...
    imageAlt: "Εικονογραφημένο ιστορικό πανόραμα από τη Μεγάλη Πυραμίδα έως την Άλωση της Βαστίλης",
  },
  ru: {
    ...
    methodNote: "Календарная близость — повод для исследования, а не доказательство причинной связи. Некоторые пересчитанные интервалы отличаются от предоставленной инфографики.",
    ...
    imageAlt: "Иллюстрированная историческая панорама от Великой пирамиды до штурма Бастилии",
  },
  zh: {
    title: "293年节点附近的历史",
    body: "这些事件和历史时段发生在293个圣年边界上或附近。负号表示边界之前，正号表示之后。",
    methodNote: "历法上的接近只供探索，并不证明周期导致了事件。按本站日期重算后，部分间隔与所附信息图不同。",
    nearBadge: "接近293年对齐点",
    ...
    imageAlt: "从吉萨大金字塔到攻占巴士底狱的历史插画全景",
  },
  hi: {
    ...
    methodNote: "कैलेंडर की निकटता खोज का एक पैटर्न है, यह प्रमाण नहीं कि चक्र ने घटना कराई। पुनर्गणित कुछ अंतर दिए गए इन्फोग्राफिक से अलग हैं।",
    ...
    imageAlt: "गीज़ा के महान पिरामिड से बैस्टिल पर धावे तक चित्रित ऐतिहासिक दृश्य",
  },
  es: {
    ...
    methodNote: "La proximidad calendárica es un patrón para explorar, no prueba de que el ciclo causara un acontecimiento. Algunos intervalos recalculados difieren de la infografía facilitada.",
    ...
    imageAlt: "Panorama histórico ilustrado desde la Gran Pirámide hasta la toma de la Bastilla",
  },
  fr: {
    ...
    methodNote: "La proximité calendaire est une piste d’exploration, non la preuve que le cycle a causé un événement. Certains écarts recalculés diffèrent de l’infographie fournie.",
    ...
    imageAlt: "Panorama historique illustré de la Grande Pyramide à la prise de la Bastille",
  },
  ja: {
    title: "293年の節目に近い歴史",
    body: "これらの出来事や期間は293聖年の境界上、またはその近くにあります。マイナスは境界前、プラスは境界後です。",
    methodNote: "暦上の近さは探究するためのパターンであり、周期が出来事を引き起こした証拠ではありません。再計算した一部の差は提示画像と異なります。",
    ...
    imageAlt: "ギザの大ピラミッドからバスティーユ襲撃までの歴史イラスト・パノラマ",
  },
  ko: {
    title: "293년 경계 가까이의 역사",
    body: "이 사건과 역사적 기간은 293 성년 경계 위나 그 가까이에 있습니다. 음수는 경계 전, 양수는 경계 후입니다.",
    methodNote: "달력상 근접성은 탐구할 패턴이지 주기가 사건을 일으켰다는 증거가 아닙니다. 다시 계산한 일부 간격은 제공된 인포그래픽과 다릅니다.",
    ...
    imageAlt: "기자의 대피라미드부터 바스티유 습격까지 이어지는 역사 삽화 파노라마",
  },
};
